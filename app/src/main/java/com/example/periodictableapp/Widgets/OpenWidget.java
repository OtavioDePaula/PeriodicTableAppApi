package com.example.periodictableapp.Widgets;
...
import com.example.periodictableapp.Activities.DeliverySetupActivity;
...
public class OpenWidget extends AppWidgetProvider {
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int i=0; i<N; i++) {
            ...
            Intent intent = new Intent(context, DeliverySetupActivity.class);
